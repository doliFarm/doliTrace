...
/**
 *  \file       dolitracecropplan_agenda.php
 *  \ingroup    dolitrace
 *  \brief      Tab of events on DoliTraceCropplan
 */
...
if ($object->id > 0) {
	$title = $langs->trans("DoliTraceCropplan")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("DoliTraceCropplan"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_dolitracecropplan_'.$object->id;
