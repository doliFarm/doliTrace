...
/**
 *       \file       htdocs/dolitrace/ajax/dolitracecropplan.php
 *       \brief      File to return Ajax response on dolitracecropplan list request
 */
...
// Security check
if (!$user->hasRight('dolitrace', 'dolitracecropplan', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolitrace/ajax/dolitracecropplan.php");
