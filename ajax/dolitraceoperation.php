...
/**
 *       \file       htdocs/dolitrace/ajax/dolitraceoperation.php
 *       \brief      File to return Ajax response on dolitraceoperation list request
 */
...
// Security check
if (!$user->hasRight('dolitrace', 'dolitraceoperation', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolitrace/ajax/dolitraceoperation.php");
