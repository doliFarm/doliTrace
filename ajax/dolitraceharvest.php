...
/**
 *       \file       htdocs/dolitrace/ajax/dolitraceharvest.php
 *       \brief      File to return Ajax response on dolitraceharvest list request
 */
...
// Security check
if (!$user->hasRight('dolitrace', 'dolitraceharvest', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolitrace/ajax/dolitraceharvest.php");
