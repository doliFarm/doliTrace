# DOLITRACE FOR [DOLIBARR ERP & CRM](https://www.dolibarr.org)
...
Clone the repository in `$dolibarr_main_document_root_alt/dolitrace`

```shell
cd ....../custom
git clone git@github.com:gitlogin/dolitrace.git dolitrace
```
