...
/**
 *  \file       dolitracecropplan_note.php
 *  \ingroup    dolitrace
 *  \brief      Tab for notes on DoliTraceCropplan
 */
...
$title = $langs->trans('DoliTraceCropplan').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("DoliTraceCropplan"), -1, $object->picto);
