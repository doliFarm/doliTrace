...
/**
 *  \file       dolitraceharvest_contact.php
 *  \ingroup    dolitrace
 *  \brief      Tab for contacts linked to DoliTraceHarvest
 */
...
$title = $langs->trans("DoliTraceHarvest")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("DoliTraceHarvest"), -1, $object->picto);
