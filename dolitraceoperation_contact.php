...
/**
 *  \file       dolitraceoperation_contact.php
 *  \ingroup    dolitrace
 *  \brief      Tab for contacts linked to DoliTraceOperation
 */
...
$title = $langs->trans("DoliTraceOperation")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-dolitrace page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("DoliTraceOperation"), -1, $object->picto);
