...
/**
 *  \file       dolitraceharvest_agenda.php
 *  \ingroup    dolitrace
 *  \brief      Tab of events on DoliTraceHarvest
 */
...
if ($object->id > 0) {
	$title = $langs->trans("DoliTraceHarvest")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("DoliTraceHarvest"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_dolitraceharvest_'.$object->id;
