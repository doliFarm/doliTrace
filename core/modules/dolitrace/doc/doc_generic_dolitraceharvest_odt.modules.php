...
/**
 *	\file       htdocs/core/modules/dolitrace/doc/doc_generic_dolitraceharvest_odt.modules.php
 *	\ingroup    dolitrace
 *	\brief      File of class to build ODT documents for dolitraceharvests
 */

dol_include_once('/dolitrace/core/modules/dolitrace/modules_dolitraceharvest.php');
 ...
 */
class doc_generic_dolitraceharvest_odt extends ModelePDFDoliTraceHarvest
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function info($langs)
	{
		...
		if ($nbofiles) {
			...
			foreach ($listoffiles as $file) {
				$texte .= '- '.$file['name'].' <a href="'.DOL_URL_ROOT.'/document.php?modulepart=doctemplates&file=dolitrace_dolitraceharvest/'.urlencode(basename($file['name'])).'">'.img_picto('', 'listlight').'</a>';
	 ...
	 *
	 *  @param	DoliTraceHarvest	$object				Source object to generate document from
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->dolitrace->dir_output) {
			...
			if (!is_object($object)) {
				$id = $object;
				$object = new DoliTraceHarvest($this->db);
