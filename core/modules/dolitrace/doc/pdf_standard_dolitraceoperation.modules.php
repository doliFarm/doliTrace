...
/**
 *	Class to manage PDF template standard_dolitraceoperation
 */
class pdf_standard_dolitraceoperation extends ModelePDFDoliTraceOperation
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliTraceOperation	$object     	Object to show
