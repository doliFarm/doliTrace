...
/**
 *	Class to manage PDF template standard_dolitracecropplan
 */
class pdf_standard_dolitracecropplan extends ModelePDFDoliTraceCropplan
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliTraceCropplan	$object     	Object to show
