...
/**
 *   	\file       dolitraceharvest_list.php
 *		\ingroup    dolitrace
 *		\brief      List page for dolitraceharvest
 */
...
include_once __DIR__.'/class/dolitraceharvest.class.php';
// for other modules
...
if ($enablepermissioncheck) {
	...
	$permissiontodelete = $user->hasRight('dolitrace', 'dolitraceharvest', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'DoliTraceHarvest';
	$objectlabel = 'DoliTraceHarvest';
...
$title = $langs->trans("DoliTraceHarvests");
//$help_url = "EN:Module_DoliTraceHarvest|FR:Module_DoliTraceHarvest_FR|ES:Módulo_DoliTraceHarvest";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/dolitrace/dolitraceharvest_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/dolitrace/dolitraceharvest_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendDoliTraceHarvestRef";
$modelmail = "dolitraceharvest";
$objecttmp = new DoliTraceHarvest($db);
