...
/**
 *  \file       dolitracecropplan_contact.php
 *  \ingroup    dolitrace
 *  \brief      Tab for contacts linked to DoliTraceCropplan
 */
...
$title = $langs->trans("DoliTraceCropplan")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("DoliTraceCropplan"), -1, $object->picto);
